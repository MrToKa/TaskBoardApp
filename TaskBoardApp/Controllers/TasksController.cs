...
namespace TaskBoardApp.Controllers
{
    public class TasksController : Controller
    {
        ...
        public IActionResult Create(TaskFormModel taskModel)
        {
            ...
            {
                this.ModelState.AddModelError(nameof(taskModel.BoardId), "Board doesn't exist.");
            }
        ...
        {
            var task = this.data.Tasks.Where(t => t.Id == id)
        ...
        private IEnumerable<TaskBoardModel> GetBoards() => this.data.Boards.Select(b => new TaskBoardModel()
        {
            Id = b.Id,
            Name = b.Name,
        });
